...
/****** Objeto: View [dbo].[vw_Tickets] Fecha de script: 25/09/2026 10:44:34 a. m. ******/
SET ANSI_NULLS ON
GO
...
/* ============================================================================
   ...
   En PRODUCCION es inofensivo: deja la vista igual que esta.
...
SELECT
    ...
    FLOOR(
        DATEDIFF(DAY, t.FechaRegistro, GETDATE()) / 30.0
    ) AS Slot
FROM dbo.Tickets t
